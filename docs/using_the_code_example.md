...
The following example clones the "[Ramping LED using smart I/O](https://github.com/Infineon/mtb-example-psoc-edge-smartio-ramping-led)" application with the desired name "Rampingled" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-smartio-ramping-led --user-app-name Rampingled --target-dir "C:/mtb_projects"
   ```
